...
<>
    <Helmet>
        ...
        <meta name="description" content="Explore the best skincare for sensitive skin products and tips at Skincare Secrets, achieve effortless healthy, glowing skin." />
        <meta name="keywords" content="Skincare for Sensitive Skin" />
        <link rel="canonical" href="https://skincaresecrets.netlify.app/" />
    </Helmet>
    <div>
           <img style={{float: 'right'}} className="picLogo" src="logo.jpg" alt="Skincare for Sensitive Skin" />
      </div>
    ...
    <p> </p>
      ...
      &nbsp;<a className="links" href="https://skincaresecrets.netlify.app/blog" target="_blank">
 Ulta's Best Clinique Products for Sensitive Skin
      </a>, check out my Featured Products below, or explore the&nbsp;
      <a className="links" href="https://skincaresecrets.netlify.app/resources" target="_blank">
     Resources page
      </a>&nbsp;
...
<footer className="footer">
  ...
  <p className="disclaimer-text">Disclaimer </p>
    ...
    The products mentioned on this website have worked well for me, but individual results may vary. Please perform a patch test before use and consult with a dermatologist if you have any concerns or pre-existing skin conditions.
    </span>
</footer>
